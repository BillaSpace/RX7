...
class YouTubeAPI:
    ...
    async def _download_audio_from_api(self, video_id: str) -> str:
        """Download audio from API with fallback to cookies"""
    ...
    async def download(
        ...
        if songvideo:
            ...
            if video_id:
                downloaded_file = await self._download_audio_from_api(video_id)
                if downloaded_file:
